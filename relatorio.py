...
for ticket in tickets:
    ...
    # 1. Condição Sprint: Procura "sprint" no status ou na justificativa
    match_sprint = "sprint" in status or "sprint" in justification

    # 2. Condição Dev: Status aguardando + justificativa equipe de desenvolvimento + vencido ou próximo (<= 2 dias)
    is_aguardando = "aguardando" in status or "aguardando" in justification
    is_dev_just = "desenvolvimento" in justification or "desenvolvimento" in status
